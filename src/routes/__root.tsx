...
function NotFoundComponent() {
  const t = strings.common.notFound;
  return (
...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  const t = strings.common.errorPage;
  useEffect(() => {
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Fair Bill Companion helps users understand and manage medical bills privately on their device." },
      { property: "og:description", content: "Fair Bill Companion helps users understand and manage medical bills privately on their device." },
      { name: "twitter:description", content: "Fair Bill Companion helps users understand and manage medical bills privately on their device." },
